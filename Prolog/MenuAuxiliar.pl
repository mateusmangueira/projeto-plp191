...
exibeRegras :-
    shell(clear),
    write('As regras do jogo são as seguintes:'),nl,nl,
    ...
    write('->O jogo acaba quando algum dos jogadores ficarem sem carta. O vencedor será quem tiver cartas no baralho.'),nl,
    menu.
